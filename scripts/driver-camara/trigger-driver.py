...
class ImperxCamera(Camera):
    def __init__(self, bit_depth: int = 8, roi: Optional[Roi] = None):
        ...
        print("Trigger Mode:",ky.KYFG_GetCameraValue(self.cam_handle_array[self.grabber_index][0], "TriggerMode"))
        print("Exposure Auto:",ky.KYFG_GetCameraValue(self.cam_handle_array[self.grabber_index][0], "ExposureAuto"))
...
#        self._start_camera(n_frames)
        ...
        print("Trigg antes")
        #ky.KYFG_SetCameraValue(self.cam_handle_array[self.grabber_index][0], 'TriggerSoftware', True)
        ky.KYFG_CameraExecuteCommand(self.cam_handle_array[self.grabber_index][0], 'TriggerSoftware')
        print(ky.KYFG_CameraExecuteCommand(self.cam_handle_array[self.grabber_index][0], 'TriggerSoftware'))
        print(ky.KYFG_GrabberExecuteCommand(self.handle[self.grabber_index], 'TriggerSoftware'))
        print("Trigg desp")
        buff_handle = 282578783305729
